          ...
          <div className="hero-text">
            ...
            {personalInfo && (
              <div className="hero-socials animate-text delay-4">
                ...
                <a href={personalInfo.youtube_url} target="_blank" rel="noopener noreferrer" className="social-icon youtube-icon" title="YouTube Channel"><i className="fab fa-youtube"></i></a>
